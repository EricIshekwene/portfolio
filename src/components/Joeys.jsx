    ...
    <div className='h-150 w-full flex flex-row    items-center justify-center'>
      ...
      <div className='h-full w-2/5 flex flex-col items-start justify-center p-10 gap-4'>
        ...
        <p className={`text-md text-gray-700 text-left font-work-sans  mb-4 ${darkMode ? 'text-white' : 'text-black'}`}>
          A responsive static website built for Joey’s Place, a local bar and restaurant. Designed a clean, modern interface with sections for events, menus, and contact info. Used React, Vite, and Tailwind CSS to create a fast, mobile-friendly experience, deployed through Cloudflare with a custom domain.  </p>
        <a
