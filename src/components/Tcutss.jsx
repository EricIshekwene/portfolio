...
export default function Tcutss({ darkMode }) {
  ...
  return (
    <>
      {isLarge ? <div id='projects' className='h-150 w-full flex flex-row    items-center justify-center'>
        ...
        <div id='projects' className=' w-full flex flex-col    items-center justify-center'>
          ...
          <div className='h-full w-full flex flex-col items-start justify-center p-10 gap-'>
            ...
            <a href="https://tcutss.com" target="_blank" rel="noopener noreferrer" className={` flex items-center justify-center font-vollkorn font-semibold py-2 px-5 rounded-full transition-all duration-300 shadow-md hover:shadow-xl hover:scale-105 ${darkMode ? 'text-black bg-white hover:bg-black hover:text-yellow-400' : 'text-white bg-black hover:bg-[#3B82F6]'}`}
            >
              LIVE SITE
            </a>
