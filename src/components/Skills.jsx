...
export default function Skills({ darkMode }) {
    ...
    return (
        <>
            {isLarge ? <motion.div
                id='skills'
                className='w-full flex flex-row md:flex-row items-center p-10 md:gap-10'
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-6 w-full">
                            <div className="w-full flex flex-col items-center">
                                ...
                                <div className='flex flex-wrap gap-4 justify-center items-center'>
                                    <IoLogoJavascript className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <TbSql className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <FaPython className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <FaJava className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <FaHtml5 className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <FaCss3Alt className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                </div>
                            </div>
                            ...
                            <div className="w-full flex flex-col items-center">
                                ...
                                <hr className='border-gray-300 w-1/3 border mt-1 mb-2' />
                                <div className='flex flex-wrap gap-4'>
                                    <SiReact className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <FaNodeJs className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <SiVite className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <SiTailwindcss className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <SiEjs className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <SiUnity className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                </div>
                            </div>
                            ...
                            <div className="w-full flex flex-col items-center">
                                ...
                                <hr className='border-gray-300 w-1/3 border mt-1 mb-2' />
                                <div className='flex flex-wrap gap-4'>
                                    <SiPostgresql className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <SiPassport className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <SiCloudinary className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <SiGithub className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                    <FaGitAlt className={`text-2xl ${darkMode ? 'text-white' : ''}`} />
                                </div>
                            </div>
                        </div>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="self-center mt-6 flex flex-row items-center justify-center"
                        >
                            <button
                                className={`flex items-center gap-3 font-vollkorn font-semibold py-3 px-8 rounded-full transition-all duration-300 shadow-md hover:shadow-xl hover:scale-105 ${darkMode ? 'bg-white text-black hover:bg-[#3B82F6] hover:text-white' : 'bg-[#3B82F6] text-white hover:bg-black hover:text-[#3B82F6]'}`}
                            >
